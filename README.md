...
This was an attempt to make an effort value tracking tool for Pokemon that could be shared via bookmarks.
Sometimes, it's good to look back to see where you started.
...
* One-click EV adding
* Overly-drag-centered interface
* Really bad code
